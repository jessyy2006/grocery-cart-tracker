...
const AlertDialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-row gap-2 [&>*]:flex-1 [&>*]:min-w-0 [&>*]:mt-0", className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("font-display text-h2 font-semibold lowercase leading-tight tracking-tight text-center", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn("text-body text-muted-foreground text-center", className)} {...props} />
));
