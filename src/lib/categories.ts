...
const KEYWORDS: Record<CategorySlug, string[]> = {
  ...
  snacks: [
    "tortilla chips","potato chips","chip","chips","crisp","crisps","pretzel","pretzels","cracker","crackers","cookie","cookies","candy","chocolate","granola bar","protein bar","candy bar","popcorn","nut","nuts","almond","almonds","cashew","cashews","peanut","peanuts","pistachio","pistachios","walnut","walnuts","pecan","pecans","trail mix","gummy","gummies","gum","snack","snacks","jerky","beef jerky","fruit snack","goldfish","oreo","oreos","doritos","cheetos","pringles","skittles","mms","snickers","kitkat","twix",
  ],
  household: [
